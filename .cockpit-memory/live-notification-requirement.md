...
Near-live Memory capture uses the same tab-independent corner but never writes into PTY bytes. A bounded green toast names Claude or Codex, says whether the fact was saved or updated, and gives its scope and reason. Already-known duplicates stay silent. Only a protected, high-impact ambiguous replacement remains visible with an Open Memory action and emits one native notification.
