...
gate: save
updatedAt: 2026-07-14T18:11:13.369Z
status: active
authority: observed
scope: project
confidence: medium
...
- (2026-07-14) Sentinel writes no longer reactivate archived notes. Archived notes have 'archived' status and cannot be resurrected by any write operation, preserving archive integrity. This was part of a systematic fix for memory health issues.
