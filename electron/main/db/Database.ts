...
const MIGRATIONS: Migration[] = [
  ...
  { version: 21, name: 'automation_jobs', sql: SCHEMA_V21 },
  { version: 22, name: 'provider_aware_memory_capture', sql: SCHEMA_V22 },
  { version: 23, name: 'observable_memory_capture_lifecycle', sql: SCHEMA_V23 },
]
